...
public class BuyStepdefs {
    ...
    @When("exceed the limit, I buy (.+) with quantity (.+)")
    public void exceed_limit(String name, int quant) {
        Product prod = catalog.getProduct(name);
        assertThrows(IllegalArgumentException.class, () -> order.addItem(prod, quant));
    }
